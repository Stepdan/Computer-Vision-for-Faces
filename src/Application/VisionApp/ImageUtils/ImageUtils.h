 ...
 */
cv::Mat QImage2cvMat(const QImage &img, int requiredMatType = CV_8UC(0), MatColorOrder requiredOrder=MCO_BGR);
QImage cvMat2QImage(const cv::Mat &mat, MatColorOrder order=MCO_BGR, QImage::Format formatHint = QImage::Format_Invalid);
 ...
 */
cv::Mat QImage2cvMat_shared(const QImage &img, MatColorOrder *order=0);
QImage cvMat2QImage_shared(const cv::Mat &mat, QImage::Format formatHint = QImage::Format_Invalid);
